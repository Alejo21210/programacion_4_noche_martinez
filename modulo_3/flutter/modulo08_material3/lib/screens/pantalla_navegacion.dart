  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Usuarios', valor: '1.2 K', icono: Icons.people,       color: cs.surfaceContainerHighest)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'BD',       valor: '5',     icono: Icons.storage,      color: cs.surfaceContainerHigh)),
        ]),
      ],
    );
  }
