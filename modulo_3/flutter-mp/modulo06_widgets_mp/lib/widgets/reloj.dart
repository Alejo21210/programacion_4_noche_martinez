    ...
    return Column(
      ...
      children: [
        ...
        if (_tiemposVuelta.isNotEmpty) ...[
          ...
          Text('Última revisión: ${_formatoSegundos(_tiemposVuelta.last)}', style: TextStyle(fontSize: 14, color: Colors.grey.shade700)),
          Text('Total de registros: ${_tiemposVuelta.length}', style: TextStyle(fontSize: 12, color: Colors.grey.shade500)),
        ],
      ],
    );
  }
