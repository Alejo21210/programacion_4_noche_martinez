  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Clínica ${esMovil ? 'móvil' : 'tablet'} · ${esRetrato ? 'retrato' : 'paisaje'}',
      ...
      body: ListView(
        ...
        children: [
          _Seccion(
            titulo: 'Información de la clínica',
            items: [
              'Pacientes atendidos hoy: 24',
              'Urgencias activas: 3',
              'Próxima cirugía: 11:30',
              'Orientación: ${MediaQuery.orientationOf(context).name}',
            ],
          ),
          const SizedBox(height: 16),
          _Seccion(titulo: 'Paleta del tema', items: []),
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: [
